...
class UserInfo : NSObject {
    ...
    func clearUserInfoWhenUserLoggedOut() {
        UserInfo.sharedInstance.removeCacheValue(key: UNUserInfoKeys.accountID)
        ...
        UserInfo.sharedInstance.removeCacheValue(key: UNUserInfoKeys.userFName)
        UserInfo.sharedInstance.removeCacheValue(key: UNUserInfoKeys.userLName)
        UserInfo.sharedInstance.removeCacheValue(key: UNUserInfoKeys.Imageurl)
        UserInfo.sharedInstance.removeCacheValue(key: UNUserInfoKeys.devicePushToken)
        ...
        UserInfo.sharedInstance.removeCacheValue(key: UNUserInfoKeys.facebookAccessToken)
    }
}
