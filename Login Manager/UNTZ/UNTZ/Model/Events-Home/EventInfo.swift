...
class EventInfo: NSObject {
    ...
    var eventStatus : UserEventStatus?
    ...
    required init(jsonDict: Dictionary<String, AnyObject>) {
        ...
        let userEventStatusDict = jsonDict["userEventStatus"] as? Dictionary<String, AnyObject>
        
        if let userEventStatusDict = userEventStatusDict {
            self.eventStatus = UserEventStatus.init(jsonDict: userEventStatusDict)
        }
