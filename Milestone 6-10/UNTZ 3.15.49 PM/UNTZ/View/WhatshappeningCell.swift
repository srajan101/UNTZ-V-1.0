...
class WhatshappeningCell: UITableViewCell {
    ...
    func generateRequestViews(postcommentObj : RequestedTrackInfo) {
        ...
        trackNameLabel.font =  UIFont(name: "Roboto-Regular", size: 14)
        ...
        reqLabel.font =  UIFont(name: "Roboto-Regular", size: 13)
        ...
        desTextLabel.font =  UIFont(name: "Roboto-Regular", size: 13)
